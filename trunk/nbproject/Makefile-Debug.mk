...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libparkville.a

dist/Debug/GNU-Linux-x86/libparkville.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${RM} dist/Debug/GNU-Linux-x86/libparkville.a
	${AR} -rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libparkville.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug/GNU-Linux-x86/libparkville.a
...
${OBJECTDIR}/src/io/keyboard.o: src/io/keyboard.c 
	${MKDIR} -p ${OBJECTDIR}/src/io
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/io/keyboard.o src/io/keyboard.c

${OBJECTDIR}/src/kernel/kernel.o: src/kernel/kernel.c 
	${MKDIR} -p ${OBJECTDIR}/src/kernel
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/kernel/kernel.o src/kernel/kernel.c

${OBJECTDIR}/src/io/display.o: src/io/display.c 
	${MKDIR} -p ${OBJECTDIR}/src/io
	${RM} $@.d
	$(COMPILE.c) -g -Isrc/inc -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/io/display.o src/io/display.c

${OBJECTDIR}/src/boot/boot-stage2.o: src/boot/boot-stage2.s 
	${MKDIR} -p ${OBJECTDIR}/src/boot
	$(AS) $(ASFLAGS) -g -o ${OBJECTDIR}/src/boot/boot-stage2.o src/boot/boot-stage2.s
